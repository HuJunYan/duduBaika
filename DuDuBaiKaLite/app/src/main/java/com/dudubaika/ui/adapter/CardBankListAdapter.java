 ...
 * 信用卡列表数据
 */
public class CardBankListAdapter extends BaseQuickAdapter<CreditCardListBean.CreditListBean,BaseViewHolder> {

    private Context mContext;

    public CardBankListAdapter(@Nullable List<CreditCardListBean.CreditListBean> data, Context context) {
        super(R.layout.item_bank_list, data);
        this.mContext = context;
    }

    @Override
    protected void convert(BaseViewHolder helper,CreditCardListBean.CreditListBean item) {
