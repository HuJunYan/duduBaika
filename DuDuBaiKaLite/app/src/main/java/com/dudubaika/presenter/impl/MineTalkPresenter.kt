 ...
 *
 */
class MineTalkPresenter @Inject constructor() :RxPresenter<TalkHomeContract.View>(),TalkHomeContract.Presenter{
    ...
    override fun loadListData(type: String) {
        ...
        addSubscribe(ApiManager.getMineTalkListData(body)
