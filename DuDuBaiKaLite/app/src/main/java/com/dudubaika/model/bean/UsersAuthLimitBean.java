...
/**
 * 获取用户额度后展示的bean(机构筛选同一个bean)
 */
public class UsersAuthLimitBean {
    ...
    private ArrayList<UsersAuthLimitBean.ProductListBean> product_list;
    ...
    public ArrayList<UsersAuthLimitBean.ProductListBean> getProduct_list() {
        return product_list;
    }

    public void setProduct_list(ArrayList<UsersAuthLimitBean.ProductListBean> product_list) {
    ...
    public static class ProductListBean {
        ...
        private List<ProductInfoListBean.ProductListBean.ProductTagsBean> product_tags;
        ...
        public List<ProductInfoListBean.ProductListBean.ProductTagsBean> getProduct_tags() {
            return product_tags;
        }

        public void setProduct_tags(List<ProductInfoListBean.ProductListBean.ProductTagsBean> product_tags) {
